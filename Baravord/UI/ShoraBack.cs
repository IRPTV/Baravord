...
{
    public partial class ShoraBack : Form
    {
        ProgramObj _ProgramGlobalObject = new ProgramObj();
        int _Dep = 1;

        public ShoraBack(int ProgramId, int Dep)
        {
        ...
        private void Shora_Load(object sender, EventArgs e)
        {
            ...
            if (_ProgramGlobalObject.Id.Equals(0))
            {
                ...
                _ProgramGlobalObject.Datetime_Edit = DateTime.Now;
                _ProgramGlobalObject.Datetime_Finance = DateTime.Now;
                _ProgramGlobalObject.Datetime_Publish = DateTime.Now;
                _ProgramGlobalObject.Datetime_Tarh = DateTime.Now;
                txtDatetime_Tarh.Text = DateConversion.GD2JD(DateTime.Now);
        ...
        private void UpdateFormByObjectPl()
        {
            ...
            {
                txtEditDatetime.Text = DateConversion.GD2JD(DateTime.Now);
                txtFinanceDatetime.Text = DateConversion.GD2JD(DateTime.Now);
                txtPublish.Text = DateConversion.GD2JD(DateTime.Now);
                txtShoraDatetime.Text = DateConversion.GD2JD(DateTime.Now);
            }
